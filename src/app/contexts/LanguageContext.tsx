...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'inventory.description': 'Your won items and rewards',
    'inventory.back': 'BACK TO CASES',
    'inventory.search': 'Search items...',
    'inventory.filterAll': 'ALL ITEMS',
    'inventory.filterSkin': 'SKINS',
    'inventory.filterPhysical': 'PHYSICAL',
    'inventory.all': 'ALL',
    'inventory.money': 'MONEY',
    'inventory.cs2Items': 'CS2 ITEMS',
    'inventory.physical': 'PHYSICAL',
    'inventory.typeSkin': 'SKIN',
    'inventory.typePhysical': 'PHYSICAL',
    'inventory.typeMoney': 'MONEY',
    'inventory.marketPrice': 'Market Price',
    'inventory.sellPrice': 'Sell Price',
    'inventory.sell': 'SELL FOR',
    'inventory.itemSold': 'Item sold for',
    'inventory.errorLoading': 'Failed to load inventory',
    'inventory.errorSelling': 'Failed to sell item',
    'inventory.noItems': 'No items in your inventory',
  ...
  ru: {
    ...
    'inventory.description': 'Ваши выигранные предметы и награды',
    'inventory.back': 'НАЗАД К КЕЙСАМ',
    'inventory.search': 'Поиск предметов...',
    'inventory.filterAll': 'ВСЕ ПРЕДМЕТЫ',
    'inventory.filterSkin': 'СКИНЫ',
    'inventory.filterPhysical': 'ФИЗИЧЕСКИЕ',
    'inventory.all': 'ВСЕ',
    'inventory.money': 'ДЕНЬГИ',
    'inventory.cs2Items': 'ПРЕДМЕТЫ CS2',
    'inventory.physical': 'ФИЗИЧЕСКИЕ',
    'inventory.typeSkin': 'СКИН',
    'inventory.typePhysical': 'ФИЗИЧЕСКИЙ',
    'inventory.typeMoney': 'ДЕНЬГИ',
    'inventory.marketPrice': 'Цена на рынке',
    'inventory.sellPrice': 'Цена продажи',
    'inventory.sell': 'ПРОДАТЬ ЗА',
    'inventory.itemSold': 'Предмет продан за',
    'inventory.errorLoading': 'Не удалось загрузить инвентарь',
    'inventory.errorSelling': 'Не удалось продать предмет',
    'inventory.noItems': 'Нет предметов в вашем инвентаре',
  ...
  lv: {
    ...
    'inventory.description': 'Jūsu uzvarētie priekšmeti un atbaldojumi',
    'inventory.back': 'ATPAKAĻ KASTĒM',
    'inventory.search': 'Meklēt priekšmetus...',
    'inventory.filterAll': 'VISI PRIEKŠMETI',
    'inventory.filterSkin': 'SKINI',
    'inventory.filterPhysical': 'FIZISKI',
    'inventory.all': 'VISI',
    'inventory.money': 'NAUDA',
    'inventory.cs2Items': 'CS2 PRIEKŠMETI',
    'inventory.physical': 'FIZISKI',
    'inventory.typeSkin': 'SKINS',
    'inventory.typePhysical': 'FIZISKI',
    'inventory.typeMoney': 'NAUDA',
    'inventory.marketPrice': 'Tirgus cena',
    'inventory.sellPrice': 'Pārdošanas cena',
    'inventory.sell': 'PĀRDOT UZ',
    'inventory.itemSold': 'Priekšmets pārdots par',
    'inventory.errorLoading': 'Neizdevās ielādēt inventāru',
    'inventory.errorSelling': 'Neizdevās pārdot priekšmetu',
    'inventory.noItems': 'Jūsu inventārī vēl nav priekšmetu',
    'inventory.status': 'STATUS',
